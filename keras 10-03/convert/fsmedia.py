...
class Alignments():
    ...
    def __init__(self, arguments):
        ...
        folder, filename = os.path.split(str(self._args.alignments_path)) if self._args.alignments_path else (str(self._args.input_dir), "alignments")
        self._file = os.path.join(str(folder), "{}.{}".format(os.path.splitext(filename)[0], 'fsa'))
