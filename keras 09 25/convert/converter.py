...
class Converter():
    ...
    """
    def __init__(self, output_size, coverage_ratio, centering, pre_encode,
    ...
    def _load_plugins(self, config=None, disable_logging=False):
        ...
        self._adjustments["mask"] = import_model(
            "convert.mask", "mask_blend", disable_logging)(self._args.mask_type,
                                             self._output_size,
    ...
    def process(self, items):
        ...
        try:
            ...
            loglevel = logger.info if log_once else logger.warning
