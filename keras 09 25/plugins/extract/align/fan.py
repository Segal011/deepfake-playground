...
class Align(Aligner):
    ...
    def process_input(self, batch):
        ...
        logger.info("Aligned image around center")
    ...
    def get_center_scale(self, detected_faces):
        ...
        logger.info("Calculated center and scale: %s", center_scale)
        return center_scale
    ...
    def transform(points, center_scales, resolutions):
        ...
        logger.info("Transformed Points: %s", retval)
        return retval
    ...
    def get_pts_from_predict(self, batch):
        ...
        logger.info("Obtained points from prediction: %s", batch["landmarks"])
