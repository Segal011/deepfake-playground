...
class TrainArgs(FaceSwapArgs):
    ...
    def get_argument_list() -> List[Dict[str, Any]]:
        ...
        argument_list.append(dict(
            ...
            dest="input_a",
            # required=True,
            default= r"C:/Users/37060/Desktop/smth/data/1",
            group=_("faces"),
        ...
        argument_list.append(dict(
            ...
            dest="input_b",
            # required=True,
            default=r"C:/Users/37060/Desktop/smth/data/2", 
            group=_("faces"),
        ...
        argument_list.append(dict(
            ...
            dest="model_dir",
            # required=True,
            default=r"C:\Users\37060\Desktop\Magistrinis-darbas\Projektas\keras\lib\model2",
            group=_("model"),
        ...
        argument_list.append(dict(
            ...
            type=str.lower,
            default=Model().name,
            choices=[Model().name],#PluginLoader.get_available_models(),
            group=_("model"),
