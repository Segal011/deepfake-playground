...
class DiskIO():
    ...
    def _get_writer(self):
        ...
        return import_model("convert.writer", self._args.writer, False)(*args,
    ...
    def _load(self):  # pylint: disable=unused-argument
        ...
        idx = 0
        # print("LOADED", self._images.load())
        print("LOADED", self._images.files.items())

        for filename, image in self._images.files.items():
            idx += 1
