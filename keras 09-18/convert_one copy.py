...
from lib.convert_one import Converter
from fsmedia import Alignments, PostProcess, finalize
...
class Convert():  # pylint:disable=too-few-public-methods
    ...
    def __init__(self, arguments):
        ...
        self._converter = Converter(self._predictor.output_size,
                                    ...
                                    False, #self._disk_io.draw_transparent,
                                    False, #self._disk_io.pre_encode,
                                    arguments,
    ...
    def _convert_images(self):
        ...
        # print("rerererer", patch_queue.get())
